...
struct P_heli_q8_T_ {
  ...
  real_T Constant_Value_k;             /* Expression: -0.5
                                        ...
                                        */
  real_T Constant1_Value;              /* Expression: -0.33
                                        * Referenced by: '<Root>/Constant1'
                                        */
  real_T Integrator_IC;                /* Expression: 0
                                        * Referenced by: '<S6>/Integrator'
                                        */
  real_T Integrator_UpperSat;          /* Expression: 0.05
                                        * Referenced by: '<S6>/Integrator'
                                        */
  real_T Integrator_LowerSat;          /* Expression: -0.05
                                        * Referenced by: '<S6>/Integrator'
                                        */
  ...
  real_T Gainx_Gain;                   /* Expression: 10/9
                                        ...
                                        */
  real_T K_lp_Gain;                    /* Expression: 0.2
                                        * Referenced by: '<S6>/K_lp'
                                        */
  real_T K_ld_Gain;                    /* Expression: 0.1
                                        * Referenced by: '<S6>/K_ld'
                                        */
  real_T Saturation_UpperSat;          /* Expression: 0.2
  ...
  real_T Integrator_UpperSat_f;        /* Expression: inf
                                        * Referenced by: '<S7>/Integrator'
                                        */
  real_T Integrator_LowerSat_c;        /* Expression: -inf
                                        * Referenced by: '<S7>/Integrator'
                                        */
  ...
  real_T BackmotorSaturation_LowerSat; /* Expression: -5
                                        * Referenced by: '<S3>/Back motor: Saturation'
                                        */
  real_T K_li_Gain;                    /* Expression: 0.01
                                        * Referenced by: '<S6>/K_li'
                                        */
 ...
 * '<S6>'   : 'heli_q8/Stop controller'
 * '<S7>'   : 'heli_q8/Elevation controller/Elevation controller'
 * '<S8>'   : 'heli_q8/Stop controller/Compare To Zero'
 * '<S9>'   : 'heli_q8/Stop controller/Detect Change'
 * '<S10>'  : 'heli_q8/Stop controller/Triggered Subsystem'
 */
